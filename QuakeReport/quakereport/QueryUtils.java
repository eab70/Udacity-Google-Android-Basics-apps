...
public final class QueryUtils {
    ...
    public static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        // Create an empty ArrayList that we can start adding earthquakes to it
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                // Extract the values for the keys called magnitude, location, time and url
            ...
            // If an error is thrown when executing the statements in the "try" block,
